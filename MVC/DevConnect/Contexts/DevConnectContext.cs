...
public partial class DevConnectContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdComentario).HasName("PK__tb_comen__1BA6C6F45DF9FB33");
        ...
        {
            entity.HasKey(e => e.IdCurtida).HasName("PK__tb_curti__0AC033CA62271854");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__tb_publi__3213E83F08357603");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__tb_usuar__3213E83F1F96BE60");
            ...
            entity.HasMany(d => d.IdSeguindo).WithMany(p => p.IdUsuarioSeguidor)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("IdUsuarioSeguidor", "IdSeguindo").HasName("PK__tb_segui__44E9DBED93D32AFB");
